...
/**
 * PauseMenuUI — เมนูหยุดเกม
 * แก้บัก:
 * - ลบปุ่ม SAVE GAME ออก (ไม่เหมาะกับทุก context)
 * - ลบ emoji ออกทั้งหมด
 * - ESC ปิดได้ปกติ
 */
public class PauseMenuUI extends JPanel {
    ...
    private JButton resumeBtn, mainMenuBtn, exitBtn;
    ...
    // ═══════════════════════════════════════════════
    //  Buttons — ไม่มี SAVE GAME, ไม่มี emoji
    // ═══════════════════════════════════════════════
    ...
    private void layoutChildren(int pw, int ph) {
        ...
        int bw = 300, bh = 56;
        int bx = (mw - bw) / 2;
        int startY = 100, gap = 76;

        resumeBtn  .setBounds(bx, startY,           bw, bh);
        mainMenuBtn.setBounds(bx, startY + gap,      bw, bh);
        exitBtn    .setBounds(bx, startY + gap * 2,  bw, bh);
    }
